...
(function (d3) {
    d3.layout.treelist = function () {
        "use strict";
        var hierarchy = d3.layout.hierarchy().sort(null).value(null), //추상 클레스 설정
            nodeHeight = 20,
            childIndent = 20,
            size;

        var treelist = function (d, i) {
            var nodes = hierarchy.call(this, d, i), //hierarchy에 treelist를 this로 제공한다.
                root = nodes[0];
            ...
            */
            ...
            layout(root);
            return nodes; //hierarcy로 부터 상속받아서 수정된 treelist
        };
